...
const Details = ({ data, onClose }) => {
  ...
  const dailyForecast = data.forecast
    ? data.forecast.filter((item) => item.dt_txt.includes("12:00:00"))
    : [];
  ...
  return (
    <DetailsSection>
      ...
      <h2 style={{ marginBottom: "30px", color: theme.text }}>
        Детальний прогноз: {data.name}
      </h2>
